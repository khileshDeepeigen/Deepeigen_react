...
export default function Profile() {
  ...
  return (
    <div className="flex min-h-screen bg-white">
      {/* Sidebar */}
      <div className="w-[315px] flex-shrink-0 border-r border-[rgba(26,33,47,0.4)] pb-7 hidden lg:flex lg:flex-col">
        {/* Go back to dashboard */}
        <button
          onClick={() => navigate("/user_dashboard")}
          className="flex items-center gap-1 px-10 py-10 pb-[60px]"
        >
          <svg
            className="w-5 h-5"
            width="20"
          ...
          <span className="text-[#1A212F] font-semibold text-base leading-[93%]">
            Go back to dashboard
          </span>
        </button>
        ...
        <div className="flex flex-col">
          ...
          <button 
            ...
            className={`flex items-center cursor-pointer gap-2.5 px-10 py-5 w-full ${
              activeSection === "profile" ? "bg-[rgba(23,76,210,0.06)]" : ""
            }`}
          >
            <svg
              className="w-5 h-5"
            ...
            <span className={`flex-1 text-left font-semibold text-base ${
              activeSection === "profile" ? "text-[#174CD2]" : "text-[rgba(26,33,47,0.7)]"
            }`}>
              Profile
            </span>
          </button>
          ...
          <button 
            ...
            className={`flex items-center cursor-pointer gap-2.5 px-10 py-5 w-full ${
              activeSection === "billing" ? "bg-[rgba(23,76,210,0.06)]" : ""
            }`}
          >
            <svg
              className="w-5 h-5"
            ...
            >
              <path
                ...
                fill={activeSection === "billing" ? "#1A212F" : "rgba(26, 33, 47, 0.7)"}
              />
            </svg>
            <span className={`flex-1 text-left font-semibold text-base ${
              activeSection === "billing" ? "text-[#174CD2]" : "text-[rgba(26,33,47,0.7)]"
            }`}>
              Billing and Invoices
            </span>
          </button>
          ...
          <button 
            ...
            className={`flex items-center cursor-pointer gap-2.5 px-10 py-5 w-full ${
              activeSection === "settings" ? "bg-[rgba(23,76,210,0.06)]" : ""
            }`}
          >
            <svg
              className="w-5 h-5"
            ...
            <span className={`flex-1 text-left font-semibold text-base ${
              activeSection === "settings" ? "text-[#174CD2]" : "text-[rgba(26,33,47,0.7)]"
            }`}>
              Settings
            </span>
          </button>
      ...
      {/* Main Content */}
      <div className="flex-1 flex flex-col px-6 lg:px-10 xl:px-36 py-7">
        {/* Page Title */}
        <h1 className="text-[#1A212F] text-[40px] font-normal leading-normal tracking-[-0.8px] mb-10">
        ...
        {activeSection === "profile" && (
          <div className="flex flex-col justify-center items-start gap-5">
            {/* Profile Picture */}
            <div className="w-40 h-40 flex justify-center items-center rounded-xl bg-[rgba(0,0,0,0.04)]">
              <svg
            ...
            {/* Profile Information */}
            <div className="flex flex-col items-start gap-5 w-full max-w-[357px]">
              {/* Name */}
              <div className="flex flex-col items-start gap-2 self-stretch rounded-lg">
                <div className="flex items-center gap-2">
                  <h2 className="text-[#1A212F] text-2xl font-bold leading-normal">
                    John Doe
                  </h2>
                </div>
              </div>
              ...
              <div className="flex items-start gap-12 flex-wrap">
                ...
                <div className="flex items-center gap-2">
                  ...
                  >
                    <path
                      d="M12.6174 13.3333C11.4938 13.3333 10.3418 13.052 9.1614 12.4893C7.98095 11.9266 6.88229 11.1366 5.8654 10.1193C4.85651 9.1024 4.07073 8.00574 3.50806 6.82929C2.9454 5.65285 2.66406 4.50307 2.66406 3.37996C2.66406 3.17996 2.73073 3.01107 2.86406 2.87329C2.9974 2.73551 3.16406 2.66663 3.36406 2.66663H5.01273C5.19406 2.66663 5.35228 2.72374 5.4874 2.83796C5.62251 2.95218 5.71384 3.09863 5.7614 3.27729L6.09206 4.86663C6.12317 5.05329 6.11762 5.21618 6.0754 5.35529C6.03317 5.4944 5.95917 5.6084 5.8534 5.69729L4.39073 7.06129C4.66451 7.55774 4.96695 8.01907 5.29806 8.44529C5.62917 8.87152 5.98251 9.27529 6.35806 9.65663C6.74473 10.0433 7.16117 10.4033 7.6074 10.7366C8.05362 11.0695 8.5434 11.3837 9.07673 11.6793L10.5027 10.228C10.6112 10.1111 10.7332 10.034 10.8687 9.99663C11.0038 9.95974 11.1536 9.9524 11.3181 9.97463L12.7201 10.2613C12.9014 10.3057 13.0485 10.3971 13.1614 10.5353C13.2743 10.6735 13.3307 10.8317 13.3307 11.01V12.6333C13.3307 12.8333 13.2618 13 13.1241 13.1333C12.9863 13.2666 12.8174 13.3333 12.6174 13.3333Z"
                      fill="#1A212F"
                      fillOpacity="0.7"
                    />
                  </svg>
                  <span className="text-[rgba(26,33,47,0.7)] text-base font-normal leading-normal">
                    +91-987654321
                  </span>
                </div>
              ...
              {/* Address */}
              <div className="text-[rgba(26,33,47,0.7)] text-base font-normal leading-normal">
                221-Baker St., London, United Kingdom
              </div>

              <div className="h-px self-stretch bg-[rgba(0,0,0,0.08)]"></div>

              {/* Edit Profile Button */}
              <button className="flex h-11 px-10 py-3 justify-center items-center gap-1 self-stretch rounded-lg border border-[#174CD2]">
                <svg
                  className="w-4 h-4"
                  width="16"
                  height="16"
                ...
                <span className="text-[#174CD2] font-semibold text-base leading-[93%]">
                  Edit profile
                </span>
              </button>
            </div>
      ...
      <button
        ...
        className="lg:hidden fixed bottom-4 right-4 flex items-center gap-2 px-4 py-2 bg-[#174CD2] text-white rounded-lg shadow-lg"
      >
        <svg
